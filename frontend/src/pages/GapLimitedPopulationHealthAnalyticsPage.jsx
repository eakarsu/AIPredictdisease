...
// Gap (Non-AI): Limited population health analytics
// Limited population health analytics
import React, { useState } from 'react';

export default function GapLimitedPopulationHealthAnalyticsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-population-health-analytics/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited population health analytics</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited population health analytics</p>
