...
// Gap (Non-AI): No integration with clinical systems
// No integration with clinical systems
import React, { useState } from 'react';

export default function GapNoIntegrationWithClinicalSystemsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-integration-with-clinical-systems/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No integration with clinical systems</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No integration with clinical systems</p>
