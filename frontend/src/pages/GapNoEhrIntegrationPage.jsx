...
// Gap (Non-AI): No EHR integration
// No EHR integration
import React, { useState } from 'react';

export default function GapNoEhrIntegrationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-ehr-integration/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No EHR integration</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No EHR integration</p>
