...
// Gap (Non-AI): No case management workflows
// No case management workflows
import React, { useState } from 'react';

export default function GapNoCaseManagementWorkflowsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-case-management-workflows/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No case management workflows</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No case management workflows</p>
