...
// Custom Feature: Travel health risk
// Travel health risk: User enters travel destination + medical history; AI assesses disease risks specific to destination + individual; recommends vaccines, prophylaxis
import React, { useState } from 'react';

export default function CFTravelHealthRiskPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-travel-health-risk/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Travel health risk</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Travel health risk: User enters travel destination + medical history; AI assesses disease risks specific to destination + individual; recommends vaccines, prophylaxis</p>
