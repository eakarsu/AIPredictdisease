...
// Gap (AI): Patients without '/comorbidity
// Patients without /comorbidity-analyze (flag patient health risk factors)
import React, { useState } from 'react';

export default function GapPatientsWithoutComorbidityPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-patients-without-comorbidity/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Patients without '/comorbidity</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Patients without /comorbidity-analyze (flag patient health risk factors)</p>
