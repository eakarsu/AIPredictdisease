...
// Gap (Non-AI): No contact tracing
// No contact tracing
import React, { useState } from 'react';

export default function GapNoContactTracingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-contact-tracing/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No contact tracing</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No contact tracing</p>
